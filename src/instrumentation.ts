...
export async function register() {
  ...
  // SQLite tuning (only when actually using SQLite). WAL lets reads proceed
  // during writes; busy_timeout waits for a lock instead of erroring. On
  // PostgreSQL these PRAGMAs don't apply and are skipped.
