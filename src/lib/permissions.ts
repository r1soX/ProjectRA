...
export const PERMS = {
  ...
  ADMIN_USERS_AVATAR:      "admin.users.avatar",
...
export const PERM_GROUPS: {
  ...
  },
  {
    group: "Экспорт",
    items: [
      { perm: PERMS.EXPORT_BOARD, label: "Экспортировать доску" },
      { perm: PERMS.EXPORT_TASKS, label: "Экспортировать задачи" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { perm: PERMS.ADMIN_USERS_AVATAR,       label: "Ставить фото пользователям" },
